...
#-------------------------------------------------------------------------------------------creación de rutas
APP_DIR="$(cd "$(dirname "$0")" && pwd)"                          #ruta del programa
REQ="${APP_DIR}/requirements.txt"                                 #ruta para requirements
PY="${APP_DIR}/venv/bin/python"                                   #ruta para entorno   
PIP="${APP_DIR}/venv/bin/pip"                                     #ruta para entorno   
USER_NAME="${USER}"                                               #toma el nombre ID de la raspberry
PNG_SRC="${APP_DIR}/assets/audiocinema.png"                       #logo
ICO_DST="${APP_DIR}/assets/audiocinema.ico"                       #logo


#-------------------------------------------------------------------------------------------lo que muestra mientras se descarga el programa en la terminal
#-------------------------------------------------------------------------------------------mensaje 1
echo "[1/3] Descargando librerías necesarias para el programa…"
sudo apt update                                                   #dependencias del sistema necesarias para GUI/audio/numpy/matplotlib
sudo apt install -y \
...
#-------------------------------------------------------------------------------------------mensaje 2
echo "[2/3] Generando el acceso directo del programa…"
# ICO opcional
...
#-------------------------------------------------------------------------------------------mensaje 3
echo "[3/3] Verificación de la instalación…"
